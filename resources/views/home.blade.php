...
<div class="btn-group container col-md-4">
        <a href="{{ URL::route('district.index')}}" data-toggle="tooltip" data-placement="bottom" title="Click to view summeries">
...
<div class="btn-group container col-md-4">
        <a class="link-tip" href="{{ URL::route('specimen.index')}}" data-toggle="tooltip" data-placement="bottom" title="Click to recieve and view specimens">
            <div class="panel panel-info">
...
<div class="btn-group container  col-md-4" >
        <a href="{{ URL::route('district.index')}}"  data-toggle="tooltip" data-placement="bottom" title="Click to manage patients">
            <div class="panel panel-info" >
...
<div class="btn-group container col-md-4">
        <a href="{{ URL::route('user.index')}}" data-toggle="tooltip" data-placement="bottom" title="Click to manage results">
            <div class="panel panel-info">
...
<div class="btn-group container col-md-4">
        <a class="link-tip" href="{{ URL::route('show.index')}}" data-toggle="tooltip" data-placement="bottom" title="Click to manage Barcodes, hospitals and specimens">
            <div class="panel panel-info">
