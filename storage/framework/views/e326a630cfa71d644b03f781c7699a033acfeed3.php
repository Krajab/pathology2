...
<div>
	<ol class="breadcrumb" style="width:97%">
		...
		<li><a href="<?php echo e(url('testcategory')); ?>">settings</a></li>
...
<div class="panel panel-primary row" style="width:97%">
    ...
    <div class="panel-body">
		 ...
		 <?php echo Form::open(array('url' => 'testcategory', 'id' => 'form-create-testcategory')); ?>
			...
			<div class="form-group">
               <?php echo e(Form::label('name', 'Test Category Name', ['class' => 'col-md-2'])); ?>
