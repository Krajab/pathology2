...
<div class="panel-body row">
	<div class="btn-group container col-md-3">
        <a href="<?php echo e(URL::route('district.index')); ?>" data-toggle="tooltip" data-placement="bottom" title="Click to view and add hospitals">
        ...
        <div class="btn-group container col-md-3">
        <a href="<?php echo e(URL::route('testcategory.index')); ?>" data-toggle="tooltip" data-placement="bottom" title="Click to view and add Test Categories">
            <div class="panel panel-info">
...
<div class="btn-group container col-md-3">
        <a class="link-tip" href="<?php echo e(URL::route('specimentype.index')); ?>" data-toggle="tooltip" data-placement="bottom" title="Click to view and add specimens">
            <div class="panel panel-info">
...
<div class="btn-group container  col-md-3" >
        <a href="<?php echo e(URL::route('district.index')); ?>"  data-toggle="tooltip" data-placement="bottom" title="Click to manage districts">
            <div class="panel panel-info" >
...
<div class="btn-group container  col-md-3" >
        <a href="<?php echo e(URL::route('testtype.index')); ?>"  data-toggle="tooltip" data-placement="bottom" title="Click to manage districts">
            <div class="panel panel-info" >
...
<div class="btn-group container col-md-3">
        <a href="<?php echo e(URL::route('user.index')); ?>" data-toggle="tooltip" data-placement="bottom" title="Click to manage Barcodes">
            <div class="panel panel-info">
